...
# sys.`argv`[ ]
- sys.argv这个函数是python脚本中最常用的一个函数.
...
>>> python test01.py 1 2 a b c,d # 运行脚本: 给参数,1个或更多都行. 1 2 a b
...
sys.argv参数的效果: 返回 脚本本身的名字 + 给定脚本的参数.
...
sys.argv就是将程序本身和给程序参数返回一个list,这个list中的索引为0的就是程序本身.
